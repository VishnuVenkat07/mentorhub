        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity:0, y:-24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.7 }}>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest mb-6"
              ...
              <FaBriefcase size={10} /> Job Openings at MentorHub
            </span>
            <h1 className="text-4xl sm:text-5xl font-black text-white mb-4" style={{ lineHeight:1.1 }}>
              Find Your Next<br /><span style={{ color:'#93c5fd' }}>Career Move</span>
            </h1>
            <p className="text-lg max-w-2xl mx-auto mb-8" style={{ color:'rgba(255,255,255,0.72)', lineHeight:1.7 }}>
              Full-time positions from our trusted hiring partner network. Apply today and take the next step in your career.
            </p>
            <div className="flex flex-wrap justify-center gap-8">
              {[{ n:'50+', l:'Hiring Partners' }, { n:'200+', l:'Placements Done' }, { n:`${jobs.length}`, l:'Open Positions' }, { n:'95%', l:'Offer Rate' }].map(s => (
